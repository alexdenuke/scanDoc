        ...
        <section className={style.rate}>
            ...
            <div className={style.selectWrap}>
                <div className={style.select}>
                    <Image className={style.image} src="/img/icons/rateDocument.svg"
                        width={140}
                        height={180}
                ...
                <div className={style.select}>
                    <Image className={style.image} src="/img/icons/rateDocument2.svg"
                        width={193}
                        height={182}
                        alt="Picture of the author" />
                ...
                <div className={style.select}>
                    <Image className={style.image} src="/img/icons/rateDocument3.svg"
                        width={246}
                        height={182}
                        alt="Picture of the author" />
